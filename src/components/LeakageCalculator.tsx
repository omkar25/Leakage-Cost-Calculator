      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Understanding how the total annual leakage is calculated
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-6">
              <div className="bg-zinc-100 dark:bg-zinc-800 rounded-lg p-6 font-mono text-sm overflow-x-auto">
                <div className="space-y-3">
                  <div className="flex flex-wrap items-center gap-2">
                    <span className="text-zinc-500">1.</span>
                    <span className="text-blue-600 dark:text-blue-400">Wasted Hours/Agent/Year</span>
                    <span>=</span>
                    <span className="bg-white dark:bg-zinc-700 px-2 py-1 rounded">{hoursWasted} hrs/day</span>
                    <span>×</span>
                    <span className="bg-white dark:bg-zinc-700 px-2 py-1 rounded">{daysPerYear} days/year</span>
                    <span>=</span>
                    <span className="font-bold text-zinc-900 dark:text-zinc-100">{formatNumber(calculations.wastedHoursPerAgentPerYear)} hrs</span>
                  </div>
                  
                  <div className="flex flex-wrap items-center gap-2">
                    <span className="text-zinc-500">2.</span>
                    <span className="text-blue-600 dark:text-blue-400">Cost/Agent/Month</span>
                    <span>=</span>
                    <span className="bg-white dark:bg-zinc-700 px-2 py-1 rounded">{hoursWasted} hrs/day</span>
                    <span>×</span>
                    <span className="bg-white dark:bg-zinc-700 px-2 py-1 rounded">{daysPerMonth} days/month</span>
                    <span>×</span>
                    <span className="bg-white dark:bg-zinc-700 px-2 py-1 rounded">${hourlyRate}/hr</span>
                    <span>=</span>
                    <span className="font-bold text-zinc-900 dark:text-zinc-100">{formatCurrency(calculations.costPerAgentPerMonth)}</span>
                  </div>
                  
                  <div className="flex flex-wrap items-center gap-2">
                    <span className="text-zinc-500">3.</span>
                    <span className="text-blue-600 dark:text-blue-400">Cost/Agent/Year</span>
                    <span>=</span>
                    <span className="bg-white dark:bg-zinc-700 px-2 py-1 rounded">{hoursWasted} hrs/day</span>
                    <span>×</span>
                    <span className="bg-white dark:bg-zinc-700 px-2 py-1 rounded">{daysPerYear} days/year</span>
                    ...
                    <span className="bg-white dark:bg-zinc-700 px-2 py-1 rounded">${hourlyRate}/hr</span>
                    <span>=</span>
                    <span className="font-bold text-zinc-900 dark:text-zinc-100">{formatCurrency(calculations.costPerAgentPerYear)}</span>
                  </div>
                  
                  <div className="flex flex-wrap items-center gap-2">
                    <span className="text-zinc-500">4.</span>
                    <span className="text-blue-600 dark:text-blue-400">Team Cost/Month</span>
                    <span>=</span>
                    <span className="bg-white dark:bg-zinc-700 px-2 py-1 rounded">{formatCurrency(calculations.costPerAgentPerMonth)}</span>
                    <span>×</span>
                    <span className="bg-white dark:bg-zinc-700 px-2 py-1 rounded">{numAgents} agents</span>
                    <span>=</span>
                    <span className="font-bold text-zinc-900 dark:text-zinc-100">{formatCurrency(calculations.totalTeamCostPerMonth)}</span>
                  </div>
                  
                  <div className="border-t border-zinc-300 dark:border-zinc-600 pt-3 mt-3">
                    <div className="flex flex-wrap items-center gap-2">
                      <span className="text-zinc-500">5.</span>
                      <span className="text-red-600 dark:text-red-400 font-semibold">Total Annual Leakage</span>
                      <span>=</span>
                      <span className="bg-white dark:bg-zinc-700 px-2 py-1 rounded">{hoursWasted} hrs/day</span>
                      <span>×</span>
                      <span className="bg-white dark:bg-zinc-700 px-2 py-1 rounded">{daysPerYear} days/year</span>
                      ...
                      <span className="bg-white dark:bg-zinc-700 px-2 py-1 rounded">{numAgents} agents</span>
                      <span>=</span>
                      <span className="font-bold text-red-600 dark:text-red-400 text-lg">{formatCurrency(calculations.totalAnnualLeakage)}</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="text-sm text-zinc-500 dark:text-zinc-400 text-center">
                All calculations update in real-time as you adjust the input parameters above.
              </div>
            </div>
          </CardContent>
        </Card>
